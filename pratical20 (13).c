...
void main()
{
    ...
    float lrm=80.95;
    float lrw=62.84;
    float ilm,ilw,lm,lw,total,nlw=0,nilw;
    ...
    nlw=lw+(lw*0.05);
    nilw=ilw-(ilw*0.05);
    printf("\n New literate women after increasing 5 percentage is : %f",nlw);
    printf("\n New illterate women after decreasing 5 percentage is : %f",nilw);
